...
func TestDefineMacros(t *testing.T) {
  ...
  `
	...
	evaluator.DefineMacro(program, env)
	...
	if !ok {
		t.Fatalf("mymacro should not be defined")
	}
	...
	if macro.Body.String() != expecetedBody {
		t.Fatalf("body is not %q. got=%q", expecetedBody, macro.Body.String())
	}
}
